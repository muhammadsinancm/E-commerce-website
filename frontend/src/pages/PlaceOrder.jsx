...
function PlaceOrder() {
  ...
  const { navigate, backendUrl, token, cartItems, setCartItems, getCartAmout, deleveryFee, products } = useContext(ShopeContext);
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      let orderData = {
        address: formData,
        items: orderItems,
        amount: getCartAmout() + deleveryFee
      }
        ...
        case 'razorpay':
          {
            ...
            if (responceRazorpay.data.success) {
              ...
              console.log(responceRazorpay.data.message);
        ...
        <div className="mt-8">
          ...
          <div className="mt-12">
            ...
            <div className="w-full text-end mt-8">
              {/* <button  className="bg-black text-white px-16 py-3 text-sm">PLASE ORDER</button> */}
              <button type="submit" className="bg-black text-white px-16 py-3 text-sm">PLASE ORDER</button>
            </div>
